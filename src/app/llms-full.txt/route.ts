...
### Folosiți Nutella® originală și ingrediente naturale?
Da, categoric! Folosim exclusiv cremă originală Nutella® Ferrero autentică (niciodată imitații, creme ieftine la găleată sau toppinguri diluate). Filosofia Munchotella este calitatea fără compromis: folosim Nutella® veritabilă, pastă pură de fistic sicilian 100% fără arome artificiale, ciocolată albă belgiană de calitate superioară și fructe proaspete tăiate pe loc la fiecare comandă.

### În ce sectoare din Chișinău livrați și în cât timp ajunge comanda?
Livrăm deserturi calde și proaspete în toate sectoarele din Chișinău: Centru, Botanica, Rîșcani, Buiucani, Ciocana, Poșta Veche și Telecentru, direct din boutique-ul nostru de pe Str. Nicolae Testemițanu 21/1. Timpul mediu de livrare este de 35-45 de minute, iar fiecare comandă călătorește în cutii termoizolante patentate cu fante speciale de aerisire, garantând că waffles și clătitele ajung la ușa ta fierbinți și perfect crocante.

### Pot trimite un desert cadou sau o surpriză dulce cuiva drag în Chișinău?
Da, cu mare drag! Munchotella este alegerea preferată pentru surprize dulci, zile de naștere sau momente romantice. Poți plasa comanda online pe www.munchotella.md, achiți securizat cu cardul sau prin MIA Plăți Instant, introduci adresa și datele destinatarului, iar curierul nostru va livra pachetul cald, elegant și impecabil ambalat direct la ușa persoanei dragi.

### Pot plasa o pre-comandă pe site în timpul zilei, înainte de deschiderea boutique-ului?
Da! Deși prepararea în bucătărie începe zilnic la ora 16:00 (program 16:00 - 00:00, miercuri închis), pe site-ul nostru www.munchotella.md poți plasa o pre-comandă în orice moment al zilei. Alegi deserturile preferate, selectezi ora dorită pentru livrare sau ridicare personală, iar echipa noastră le va pregăti proaspăt pe loc imediat ce deschidem cuptorul.

### Pot personaliza desertul sau solicita opțiuni fără anumiți alergeni / fructe?
Cu siguranță! La Munchotella fiecare desert este asamblat manual pe loc. Poți adăuga extra toppinguri (Nutella®, ciocolată albă belgiană, fistic mărunțit, Lotus Biscoff, Kinder Bueno) sau poți specifica în nota comenzii preferințele tale speciale — de exemplu excluderea alunelor/arahidelor pentru alergii sau alegerea anumitor fructe proaspete (căpșuni, banane, kiwi).
`;
