...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isAuthenticated === null) {
    return (
      <div className={`min-h-screen bg-[#FAF7F2] font-body-md flex flex-col items-center justify-center space-y-4 ${outfit.variable} ${playfair.variable} font-sans`}>
  ...
  if (isAuthenticated === false) {
    return (
      <div className={`min-h-screen bg-[#FAF7F2] font-body-md flex items-center justify-center p-6 relative ${outfit.variable} ${playfair.variable} font-sans`}>
        <div
  ...
  return (
    <div className={`min-h-screen bg-[#FAF7F2] font-body-md relative overflow-hidden ${outfit.variable} ${playfair.variable} font-sans`}>
